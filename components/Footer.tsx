  ...
  return (
    ...
    <footer className="bg-slate-950 text-slate-400 py-16 px-4 sm:px-6 border-t border-slate-800">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        <div className="lg:col-span-1 space-y-6">
          ...
          <div className="flex space-x-3">
            <a href="#" className="w-10 h-10 rounded-xl bg-slate-800 flex items-center justify-center text-slate-300 hover:bg-brand-600 hover:text-white transition">
             <FaLinkedinIn />
            </a>
            <a href="#" className="w-10 h-10 rounded-xl bg-slate-800 flex items-center justify-center text-slate-300 hover:bg-brand-600 hover:text-white transition">
              <BsTwitterX />
      ...
      <div className="max-w-7xl mx-auto border-t border-slate-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs! text-slate-500">
        <p>&copy; 2026 Hayaibu Talent Ltd. All rights reserved. Designed for UK Private Healthcare Networks.</p>
        <div className="flex gap-6">
          <a href="#" className="hover:text-brand-400 transition">Privacy Policy</a>
          <a href="#" className="hover:text-brand-400 transition">Terms of Service</a>
