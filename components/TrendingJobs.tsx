...
export default function TrendingJobs() {
  ...
  return (
    <div className="pad container mx-auto flex flex-col items-center  ">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-0 md:gap-x-5  gap-y-5 w-full p-1 mt-4">
        {jobs.map((job) => (
          <div key={job.id} className="flex items-center gap-5 shadow  p-1 lg:p-7 rounded-lg">
            <Image
              src="/job-icon.png"
              alt="logo"
              width={500}
