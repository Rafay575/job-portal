                ...
                users.map((user, index) => (
                  ...
                  >
                    ...
                    <TableCell className="text-center">
                      <div
                        className={`text-white font-[500] py-1 w-[80px]! mx-auto rounded-full text-xs text-center ${getTypeStyles(user.type)}`}
                      >
                        {user.type === "permanent"
                          ? "Permanent"
                    ...
                    <TableCell>
                      <div
                        className={`font-[500] py-1 w-[70px]! mx-auto rounded-full text-xs text-center ${getStatusStyles(user.is_approved)}`}
                      >
